<template>
    <div>
        ...
        <b-container class="p-0__mobile z-index-1000 position-relative mt-50px mt-mobile-0">
            <b-row>
        ...
        <section class="d-flex flex-column">
            ...
            <weather-section class="order-lg-0 order-4 d-block d-lg-none px-4 mt-0"
            ...
            <banner-right :only-image="true" :image="location.banner_first_path"
                          class="order-lg-0 order-3 overflow-hidden"></banner-right>
            <b-container class="order-lg-0 order-6">
                ...
                <b-row class="mt-5 mb-5">
                    <b-col cols="12" lg="4" class="jd-font-medium jd-text-18 jd-text-dark"
                           v-html="location.facts_left"></b-col>
                    <b-col cols="12" lg="7" offset="0" offset-lg="1"
                           class="jd-font-medium jd-text-18 jd-text-light d-none d-lg-block"
                           v-html="location.facts_right"></b-col>
                </b-row>
            </b-container>
